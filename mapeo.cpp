...
{//COORDENADAS MUNDIALES O DEL MUNDO REAL
    //PUEDEN USARSE CUALQUIER TIPO DE UNIDADES DE MEDIDA
    //km, mts, cm, mm, millas, pulgadas , etc
       XWmin=WX1; YWmin=WY1;  XWmax=WX2; YWmax=WY2;
}
void Mapeo::puerto(int VX1,int VY1,int VX2,int VY2)
{//AREA DE DESPLIEGUE, TODA LA FORMA, LA MITAD LA FORMA
    // LA CUARTA PARTE, LO QUE EL USUARIO REQUIERA
      XPVmin=VX1;
      YPVmin=VY1;
      XPVmax=VX2;
      YPVmax=VY2;
